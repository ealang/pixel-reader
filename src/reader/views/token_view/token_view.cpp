...
TokenView::TokenView(std::shared_ptr<DocReader> reader, DocAddr address, RangeDB &range_db, SystemStyling &sys_styling, TokenViewStyling &token_view_styling)
    : state(std::make_unique<TokenViewState>(reader, address, range_db, sys_styling, token_view_styling))
{
}
