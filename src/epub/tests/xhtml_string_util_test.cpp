...
TEST(XHTML_STRING_UTIL, count_non_whitespace_chars)
{
    EXPECT_EQ(count_non_whitespace_chars(""), 0);
    EXPECT_EQ(count_non_whitespace_chars(" "), 0);
    EXPECT_EQ(count_non_whitespace_chars("asdf"), 4);
    EXPECT_EQ(count_non_whitespace_chars("\tasdf λv\n\r"), 6);
}
